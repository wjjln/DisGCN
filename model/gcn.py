...
class gcn(base_model):
    ...
    def initializeNodes(self):
        super(gcn, self).initializeNodes()
    ...
    def propagate(self, user_p, layer, item_e=None):
        ...
        # user_embedding_last = self.u_self_connect[layer](user_embedding_from_item + self.user_self_value*user_p)
    ...
    def constructTrainGraph(self):
        ...
        user_embedding_last, item_embedding_last = [tmp_user_embedding], [tmp_item_embedding]
